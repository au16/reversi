...
io.sockets.on('connection', function(socket) {
	...
	*/
	...
	invite_response:
		{
		'result': 'success',
		'socket_id' : the socket id of ther person being invited
		}
	or
		{
		'result': 'fail',
...
/*Check that the message can be traced to a username*/
		...
		/*Tell the invitee they are being invited*/
		var success_data = {
							result: 'success',
			socket_id: socket.id
		};
	...
	uninvite_response:
		{
		'result': 'success',
		'socket_id' : the socket id of ther person being uninvited
		}
	or
		{
		'result': 'fail',
	...
	uninvited:
		{
	'result': 'success',
		'socket_id' : the socket id of ther person doing the inviting
		}
	or
		{
		'result': 'fail',
...
/*Check that the message can be traced to a username*/
		...
		/*Tell the uninvitee they have neen uninvited*/
		var success_data = {
							result: 'success',
			socket_id: socket.id
		};
...
/* game_start command */
	/* payload:
		{
	 	'requested_user': the socket id of the person to bplay with
		}
	 	
	game_start_response:
		{
		'result': 'success',
		'socket_id' : the socket id of ther person you are playing with
...
/*Check that the message can be traced to a username*/
		...
		var error_message = 'game_start requested a user that wasn\'t in the room, command aborted';
			...
			return;
			  ...
			  /*If everything is okay respond to the game started that it was successful*/
